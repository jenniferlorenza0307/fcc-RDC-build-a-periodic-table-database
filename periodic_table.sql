...
--
-- Name: elements elements_name; Type: CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.elements
    ADD CONSTRAINT elements_name UNIQUE (name);
...
ALTER TABLE ONLY public.elements
    ADD CONSTRAINT elements_symbol UNIQUE (symbol);
